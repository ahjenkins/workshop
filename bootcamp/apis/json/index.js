...
app.post("/recipe", (req, res) => {
  ...
  if (choice == "chicken") {
    recipeName = chicken.name;
    proteinName = chicken.ingredients.protein.name;
    proteinPrep = chicken.ingredients.protein.preparation;
    protein = proteinName + ", " + proteinPrep;
    salsa = chicken.ingredients.salsa.name;
    console.log("protein:", protein);
    toppings = chicken.ingredients.toppings;
  } else if (choice == "beef") {
    recipeName = beef.name;
    proteinName = beef.ingredients.protein.name;
